...
function FacturationPresta({ isOpen, onClose, selectedRecord, fetchData }) {
  const [formData, setFormData] = useState({
    numero: "",
    date_fac: "",
    date_arrive: "",
    date_reception: "",
    nature: selectedRecord.service,
    periode_debut: "",
    periode_fin: "",
    fournisseur: selectedRecord.nom,
      ...
      >
        <div className="modal-content">
          <div className="modal-header">
            <h3 className="modal-title">Facturation de {selectedRecord.nom}</h3>
...
export default FacturationPresta;
